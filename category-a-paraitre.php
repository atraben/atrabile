...
<div id="content" class="wrap">
	<div id="inner-content" class="clearfix">
		<?php
			$query = new WP_Query(array('cat' => 3, 'order' => ASC));
			...
			<div class="coleft post post-<?php the_ID();?> clearfix">
				...
				<?php 
				        ...
				        if ($tags) {
				            ...
				            $queryAuteurs = new WP_Query($args);
				            if ($queryAuteurs->have_posts()) {
				                while ($queryAuteurs->have_posts()):
				                    $queryAuteurs->the_post(); 
				?>
				<?php $title = get_post_meta($post -> ID, "custom-title", true);?>
				<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php $title;?>"><?php echo $title;?>
					<? if(($queryAuteurs->current_post + 1) == $queryAuteurs->post_count) echo '' ?>
					<? if(($queryAuteurs->current_post + 1) != $queryAuteurs->post_count) echo ' , ' ?>
					</a>
				<?php
				endwhile;
				...
				<div class="content-indent clearfix<? if(($query->current_post + 1) == $query->post_count) echo ' last' ?>">
					...
					<div class="livre-content">
						...
						<strong class="cat-desc"><?php $categoryname = get_the_category();
							...
							<div class="livre-tech"><?php echo get('technique');?><br />
